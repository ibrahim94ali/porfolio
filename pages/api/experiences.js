export const experiences = [
  {
    ...
    responsibilities: [
      "Working with an engineering team of 20 members in FE and hundreds of people to communicate for tasks (BE, Testers, Designers, Accessability Team, etc)",
  ...
  },
  {
    ...
    responsibilities: [
      ...
      "Do a good job working for VMware CSP as a contractor",
    ],
    technologies: [
      "Figma",
      "Javascript",
  ...
  },
  {
    ...
    info: "Technoperia is a company working in software solutions and has its own product named Bus2Go. Bus2Go is a platform where customers can purchase bus tickets online by using 3D secure payment in the web or in the mobile app and use the QR codes for their tickets. Bus drivers can validate tickets by using the mobile app and camera of their phones to scan QR codes. Bus companies can also CRUD routes, timetables, prices, etc.",
    responsibilities: [
