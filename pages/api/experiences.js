export const experiences = [
  {
    ...
    responsibilities: [
      "Working with an engineering team of 20 members in FE and hundreds of people to communicate (BE, Testers, Designers, Managers, Accessability team, etc)",
  ...
  },
  {
    ...
    responsibilities: [
      ...
      "Learn, design and implement solutions with new technologies",
      "Share knowledge in the team",
      "Help people with interview questions",
      "Working effectively for VMware CSP as a contractor",
    ],
    technologies: [
      "Figma",
      "Javascript",
